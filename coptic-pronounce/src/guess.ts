...
const LEXICAL_EN: Rule[] = [
  ...
  { from: 'empenchois', to: 'ⲙ̀ⲡⲉⲛⲟ̅ⲥ̅', score: 1 },
  { from: 'chois', to: 'ⲟ̅ⲥ̅', score: 1 },
  { from: 'shois', to: 'ϭⲟⲓⲥ', score: 1 },
  { from: 'efnouti', to: 'Ⲫ̀ⲛⲟⲩϯ', score: 1 },
  { from: 'pnouti', to: 'ⲡⲛⲟⲩϯ', score: 0.9 },
  { from: 'ekhrestos', to: 'ⲭ̅ⲥ̅', score: 1 },
  { from: 'ekrestos', to: 'ⲭ̅ⲥ̅', score: 0.95 },
  { from: 'pikhrestos', to: 'Ⲡⲭ̅ⲥ̅', score: 1 },
  { from: 'empikhrestos', to: 'ⲙ̀Ⲡⲭ̅ⲥ̅', score: 1 },
  { from: 'pikhristos', to: 'Ⲡⲓⲭ̀ⲣⲓⲥⲧⲟⲥ', score: 0.95 },
  { from: 'isous', to: 'Ⲓⲏ̅ⲥ̅', score: 1 },
  { from: 'allelouia', to: 'ⲁ̅ⲗ̅', score: 1 },
  { from: 'alleluia', to: 'ⲁ̅ⲗ̅', score: 0.95 },
...
const LEXICAL_AR: Rule[] = [
  ...
  { from: 'امبين شويس', to: 'ⲙ̀ⲡⲉⲛⲟ̅ⲥ̅', score: 1 },
  { from: 'امبينشويس', to: 'ⲙ̀ⲡⲉⲛⲟ̅ⲥ̅', score: 1 },
  { from: 'شويس', to: 'ϭⲟⲓⲥ', score: 1 },
  { from: 'افنوتي', to: 'Ⲫ̀ⲛⲟⲩϯ', score: 1 },
  { from: 'اخرستوس', to: 'ⲭ̅ⲥ̅', score: 0.95 },
  { from: 'بيخرستوس', to: 'Ⲡⲭ̅ⲥ̅', score: 1 },
  { from: 'امبي اخرستوس', to: 'ⲙ̀Ⲡⲭ̅ⲥ̅', score: 1 },
  { from: 'امبياخرستوس', to: 'ⲙ̀Ⲡⲭ̅ⲥ̅', score: 1 },
  { from: 'ايسوس', to: 'Ⲓⲏ̅ⲥ̅', score: 1 },
  { from: 'الليلويا', to: 'ⲁ̅ⲗ̅', score: 1 },
