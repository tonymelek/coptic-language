...
const CASES = [
  ...
  ['ⲅⲁⲣ', 'ghar'],
  ['ⲭ̅ⲉ̅', 'Shere ne Maria'],
  ['ⲙ̀ⲭ̅ⲉ̅', 'emShere ne Maria'],
  ['ⲛ̀ⲭ̅ⲉ̅', 'enShere ne Maria'],
  ['ⲙ̀ⲭ̅ⲉ', 'emShere ne Maria'],
  ['ⲭⲉⲣⲉ', 'Shere'],
  ['ⲙ̀ⲭⲉⲣⲉ', 'emShere'],
  ['ⲛ̀ⲭⲉⲣⲉ', 'enShere'],
  ['Ⲡⲭ̅ⲥ̅', 'Pikhrestos'],
  ['ⲙ̀Ⲡⲭ̅ⲥ̅', 'emPikhrestos'],
  ['ⲛ̀Ⲡⲭ̅ⲥ̅', 'enPikhrestos'],
  ['Ⲓⲏ̅ⲥ̅', 'Isous'],
  ['ⲁ̅ⲗ̅', 'Allelouia'],
  ['Ⲡⲓⲭ̀ⲣⲓⲥⲧⲟⲥ', 'Pikhrestos'],
  ['ⲭ̅ⲥ̅', 'Ekhrestos'],
  ['ⲭⲱ', 'ko'],
  ['ⲡⲉⲛⲟ̅ⲥ̅', 'Penchois'],
  ['ⲙ̀ⲡⲉⲛⲟ̅ⲥ̅', 'emPenchois'],
  ['ⲙ̀ⲡⲉⲛϭⲟⲓⲥ', 'emPenchois'],
  ['ⲟ̅ⲥ̅', 'chois'],
];
...
const AR_CASES = [
  ...
  ['ⲭ̅ⲉ̅', 'شيرى نى ماريا'],
  ['ⲙ̀ⲭ̅ⲉ̅', 'إمشيرى نى ماريا'],
  ['ⲛ̀ⲭ̅ⲉ̅', 'إنشيرى نى ماريا'],
  ['ⲭⲉⲣⲉ', 'شيرى'],
  ['ⲙ̀ⲭⲉⲣⲉ', 'إمشيرى'],
  ['ⲛ̀ⲭⲉⲣⲉ', 'إنشيرى'],
  ['Ⲡⲭ̅ⲥ̅', 'بي اخرستوس'],
  ['ⲙ̀Ⲡⲭ̅ⲥ̅', 'إمبي اخرستوس'],
  ['ⲛ̀Ⲡⲭ̅ⲥ̅', 'إنبي اخرستوس'],
  ['Ⲓⲏ̅ⲥ̅', 'إيسوس'],
  ['ⲁ̅ⲗ̅', 'الليلويا'],
  ['ⲡⲉⲛⲟ̅ⲥ̅', 'بين شويس'],
  ['ⲙ̀ⲡⲉⲛⲟ̅ⲥ̅', 'إمبين شويس'],
  ['ⲙ̀ⲡⲉⲛϭⲟⲓⲥ', 'إمبين شويس'],
  ['ⲭ̅ⲥ̅', 'اخرستوس'],
  ['ⲟ̅ⲥ̅', 'شويس'],
];
